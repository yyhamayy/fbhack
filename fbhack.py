...
os.system('rm -rf .number.txt')
for n in range(8310):
    nmbr = random.randint(1111111, 9999999)
    sys.stdout = open('.number.txt', 'a')
    print nmbr
    sys.stdout.flush()
...
def menu():
    ...
    print '\x1b[31;1m 0 \x1b[0;1m- Darchon\x1b[31;1m (Exit)'
    print '\x1b[90;1m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\x1b[0;1m'
    action()
...
def action():
    ...
    time.sleep(0.1)
    psb('[\xe2\x9c\x93] chaware bka...')
    time.sleep(0.1)
    psb('[!] bo wastandne tool CTRL Then Press z')
    time.sleep(0.1)
    print '\x1b[1;97m--------------------------------------------------'
...
if __name__ == '__main__':
	#os.system('xdg-open https://github.com/kakamoo')
	menu()
